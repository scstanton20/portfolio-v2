    ...
    <PageTransition>
      <div className="mt-24 w-full mb-32">
        ...
        <p className="text-gray-800 dark:text-gray-300 leading-6 font-light tracking-wide mb-12">
          ...
          and extensive technical production background. I am highly adaptable
          and dedicated to ensuring team members and customers alike have the
          tools they need to be successful. I am excited to see what the future
          of entertainment technology brings to impactful storytelling and the
          effect it will have on the theme park industry.
        </p>

        <h2 className="font-medium text-3xl mb-4">Certifications 🏆</h2>
        <p className="text-gray-800 dark:text-gray-300 leading-6 font-light tracking-wide mb-6">
          Through my time as a student and working at different businesses, I
          have accumulated some interesting certifications. Hover your mouse
          over each icon for more details.
        </p>
        ...
        <p className="text-gray-800 dark:text-gray-300 leading-6 font-light tracking-wide mb-6">
          At work and in my free time, I love partnering on projects that make
          things work better for my co-workers, my friends, and me. I enjoy
          using my technological skills to create innovative solutions to our
          problems and create new opportunities. Included below are some of
          these projects.
        </p>
            ...
            <Link key={project._id} href={project.projectLink} target="_blank">
              <div className="flex mt-auto flex-col gap-1 p-2 bg-white/10 dark:bg-black/10 rounded-md border border-slate-400 hover:border-slate-700 dark:border-slate-800 dark:hover:border-slate-600 transition-colors duration-75 cursor-pointer">
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex gap-2 flex-row items-center text-sm text-gray-800/70 dark:text-gray-100/70">
                    <BiCalendarCheck className="h-4 w-4" /> Status:{' '}
